    ...
    <div class="teachuos-content2">
        ...
        <div class="flex-container-1000-200-l100">	
            ...
            <div class="index_comic">
                <a class='teachuos-index-navigation hover_image index_comic2' href="<?= PluginEngine::getURL('teachUOS/pages/cw', ['cid' => $teachUOS_course_id, 'selected' => $study_block_id]) . "#/structural_element/2" ?>" >
